...
//inline fun  Flowable<UserResult>.transfer(v: HRIView<*>): Flowable<UserResult> {
//    return this.compose(XApi.getApiTransformer<UserResult>())
...
//                v.hideIndicator()
//                v.showError(it.message!!)
//                return@Function Publisher<UserResult> { s -> s.onComplete() }
//            })
//
//
//
...
//private fun <T> Flowable<T>.onErrorResumeNext(function: Function<Throwable, Publisher<T>>): Flowable<T> {
