 ...
 * desc:BaseActivity基类
 */
abstract class BaseActivity<P : IPresent<*>> : XActivity<P>(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks, HRIView<P> {

    public val APP_PERMISSION = 7123;
    ...
    open fun isLackPermission(permission: Array<String>): Boolean {
        var result = true
        for (p in permission) {
