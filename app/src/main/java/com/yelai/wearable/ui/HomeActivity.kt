...
import com.yelai.wearable.ui.day.DayFragment
...
class HomeActivity : BaseActivity<PViod>() {
    ...
    private val mFragments by lazy { listOf(DayFragment.newInstance(),CourseFragment.newInstance(),SportFragment.newInstance(),DiscoveryFragment.newInstance(),MineFragment.newInstance()) }
    private val mTitles = arrayOf("DAY", "课程", "运动", "发现","我的")
    private val mIconUnselectIds = intArrayOf(R.drawable.tab_icon_day_normal, R.drawable.tab_icon_course_normal, R.drawable.tab_icon_sport_normal, R.drawable.tab_icon_discovery_normal,R.drawable.tab_icon_mine_normal)
    private val mIconSelectIds = intArrayOf(R.drawable.tab_icon_day_press, R.drawable.tab_icon_course_press, R.drawable.tab_icon_sport_press, R.drawable.tab_icon_discovery_press,R.drawable.tab_icon_mine_press)
