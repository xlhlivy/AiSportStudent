...
class SportTypeChoiceActivity : BaseActivity<SportContract.Presenter>(),SportContract.View{


    override fun success(type: SportContract.Success, data: Any) {

        if(type == SportContract.Success.Type){

            val list = data as List<SportType>
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        adapter.setData(AppData.sportTypeList)
...
//        adapter.notifyDataSetChanged()
    ...
    internal inner class Adapter(context: Context) : SimpleRecAdapter<SportType, Adapter.ViewHolder>(context) {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                ...
                AppData.sportTypeList.clear()

                AppData.sportType = item
        ...
        internal inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            fun setData(data: SportType) {

                itemView.tvSportName.text = data.name
            }
