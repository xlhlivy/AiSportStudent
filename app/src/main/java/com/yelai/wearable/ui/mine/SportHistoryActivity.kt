...
import com.yelai.wearable.ui.mine.SportHistoryFragmentV2.Type
...
class SportHistoryActivity : BaseActivity<PViod>(){
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        mToolbar.setMiddleText("运动历史", ContextCompat.getColor(this, R.color.text_black_color))
        ...
        mFragments.add(SportHistoryFragmentV2.newInstance(Type.ALL))
        mFragments.add(SportHistoryFragmentV2.newInstance(Type.WEEK))
        mFragments.add(SportHistoryFragmentV2.newInstance(Type.MONTH))
        mFragments.add(SportHistoryFragmentV2.newInstance(Type.TERM))
