package com.yelai.wearable.step;
...
import com.yelai.wearable.step.accelerometer.StepCount;
import com.yelai.wearable.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private String notificationId = "stepService.debug";
    private String notificationName = "stepService.debug.name";
...
//        ;
        ...
        Notification notification = notification(CURRENT_STEP);
    ...
    private Notification notification(int step) {
        ...
        if (0 != smallIcon) {
            ...
            mBuilder.setSmallIcon(R.drawable.ic_notification_default);// 设置通知小ICON
        }
        ...
        if (0 != largeIcon) {
            ...
            mBuilder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_notification_default));

        }
        mBuilder.setTicker(getString(R.string.app_name));
        mBuilder.setContentTitle(getString(R.string.title_notification_bar, String.valueOf(step)));
...
//        nm.notify(R.string.app_name, notification);
    ...
    private void initTodayData() {
        ...
        DbUtils.createDb(this, StepData.class);
        DbUtils.getLiteOrm(StepData.class).setDebugged(false);
        //获取当天的数据，用于展示
...
//        hangIntent.setClassName("cn.bluemobi.dylan.step.activity","MainActivity");
//
//
...
//        mNotificationManager.notify(notifyId_Step, notification(CURRENT_STEP));
        if (mCallback != null) {
...
//        mNotificationManager.notify(notify_remind_id, mBuilder.build());
    ...
    public void onDestroy() {
        ...
        Sensor detectorSensor = sensorManager.getDefaultSensor(Sensor.TYPE_STEP_DETECTOR);
        if (countSensor != null) {
            sensorManager.unregisterListener(StepService.this, countSensor);
        } else if (detectorSensor != null) {
            sensorManager.unregisterListener(StepService.this, detectorSensor);
        } else {
