package com.yelai.wearable.widget.slider;
...
public class CustomSlideToUnlockView extends RelativeLayout {
    ...
    public int  slideImageViewResId;//滑块资源
    private int  slideImageViewResIdAfter;//滑动到右边时,滑块资源id
    public int  viewBackgroundResId;//root 背景
    private String textHint;//文本
    private int textSize;//单位是sp,只拿数值
    public int textColorResId;//颜色,@color
    ...
    protected void initView() {
        ...
        tvParams.setMargins(0, 0, slideImageViewWidth/2, 0);//textview的marginRight设置为和滑块的宽度一致
        ...
        tv_hint.setText(TextUtils.isEmpty(textHint)? ">>滑动停止":textHint);
